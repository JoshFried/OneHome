...
//     'ChIJfa5skuXNQIYRqmKStrxzUw0'
//   );
//   const [markerMap, setMarkerMap] = useState({});
//   const [verifiedPlaces, setVerifiedPlaces] = useState([]);
//   const [verifiedIDs, setVerifiedIDs] = useState([]);
//   const { isLoaded, loadError } = useLoadScript({
//     googleMapsApiKey: THE_API_KEY,
//     libraries,
//   });

// useEffect(() => {
//   const loadData = await fetchDataToLoadMap()
// }, [])

//   useEffect(() => {
//     axios
//       .get(
//         `https://maps.googleapis.com/maps/api/place/nearbysearch/json?input=homeless%20shelter&keyword=homeless%20shelter&inputtype=textquery&fields=photos,geometry,formatted_address,name,photos,opening_hours,rating,formatted_phone_number,website&&radius=100000&location=${latitude},${longitude}&key=${config.MAPS_API_KEY}`,
//         {}
//       )
//       .then((response) => {
...
//     axios
//       .get(
//         `http://localhost:8080/shelter/getShelters?radius=100000&longitude=${longitude}&latitude=${latitude}`,
//         {}
//       )
//       .then((response) => {
...
//           axios
//             .get(
//               `https://maps.googleapis.com/maps/api/place/details/json?place_id=${element.placeId}&fields=name,formatted_address,geometry&key=${config.MAPS_API_KEY}`,
//               {}
//             )
//             .then((response) => {
//               const newShelter = response.data;
...
//             options={{
//               icon: `${shelter.shelterId ? greenMarker : blueMarker}`,
//             }}
//           />
//         ))}
...
//                 link={`https://cors-anywhere.herokuapp.com/https://www.google.com/maps/search/?api=1&query=Google&query_place_id=${selectedPlace.place_id}`}
//               />
...
//               )}
//               {selectedPlace.rules ? (
//                 <ShelterSignUp data={selectedPlace} />
//               ) : (
//                 <div></div>
//               )}
//             </div>
